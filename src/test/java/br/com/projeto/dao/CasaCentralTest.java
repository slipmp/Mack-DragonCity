...
public class CasaCentralTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void testRetrieve() throws SQLException {
    	CasaCentral u = CreateToUseInTests();
    	CasaCentral u2=dao.findById(CasaCentral.class, u.getCodigo());
    	assertNotNull(u2);
    ...
    public void testDelete() throws SQLException {
    	CasaCentral u = CreateToUseInTests();
    	dao.remove(CasaCentral.class,u.getCodigo());
        System.out.println("testDelete Concluido!");
    }
    
    private CasaCentral CreateToUseInTests()
    {
        CasaCentral u = new CasaCentral();
        u.setPontosXP(10);
        dao.insert(u);
