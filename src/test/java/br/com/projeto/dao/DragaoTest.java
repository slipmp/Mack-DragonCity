...
public class DragaoTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void testRetrieve() throws SQLException {
    	Dragao u = CreateToUseInTests();
    	Dragao u2=dao.findById(Dragao.class, u.getCodigo());
    	assertNotNull(u2);
    ...
    public void testDelete() throws SQLException {
    	Dragao u = CreateToUseInTests();
    	dao.remove(Dragao.class,u.getCodigo());
        System.out.println("testDelete Concluido!");
    }
    
    private Dragao CreateToUseInTests()
    {
    	Dragao u = new Dragao();
        u.setLevel(2);
        dao.insert(u);
