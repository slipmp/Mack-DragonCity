...
public class FrutaTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void testRetrieve() throws SQLException {
    	Fruta u = CreateToUseInTests();
    	Fruta u2=dao.findById(Fruta.class, u.getCodigo());
    	assertNotNull(u2);
    ...
    public void testDelete() throws SQLException {
    	Fruta u = CreateToUseInTests();
    	dao.remove(Fruta.class,u.getCodigo());
        System.out.println("testDelete Concluido!");
    }
    
    private Fruta CreateToUseInTests()
    {
    	Fruta u = new Fruta();
        u.setValor(2);
        dao.insert(u);
