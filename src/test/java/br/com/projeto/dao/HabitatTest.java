...
public class HabitatTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void testRetrieve() throws SQLException {
    	Habitat u = CreateToUseInTests();
    	Habitat u2=dao.findById(Habitat.class, u.getCodigo());
    	assertNotNull(u2);
    ...
    public void testDelete() throws SQLException {
    	Habitat u = CreateToUseInTests();
    	dao.remove(Habitat.class,u.getCodigo());
        System.out.println("testDelete Concluido!");
    }
    
    private Habitat CreateToUseInTests()
    {
    	Habitat u = new Habitat();
        u.setValor(2);
        dao.insert(u);
