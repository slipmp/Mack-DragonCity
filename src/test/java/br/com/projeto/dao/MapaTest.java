...
public class MapaTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void testRetrieve() throws SQLException {
    	Mapa u = CreateToUseInTests();
    	Mapa u2=dao.findById(Mapa.class, u.getCodigo());
    	assertNotNull(u2);
    ...
    public void testDelete() throws SQLException {
    	Mapa u = CreateToUseInTests();
    	dao.remove(Mapa.class,u.getCodigo());
        System.out.println("testDelete Concluido!");
    }
    
    private Mapa CreateToUseInTests()
    {
    	Mapa u = new Mapa();
        u.setoListMapaLocal(null);
        dao.insert(u);
